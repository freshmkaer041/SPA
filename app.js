...
let reservationFrom =document.querySelector('.reservation_from');
let reservationTo =document.querySelector('.reservation_to');

dateFrom.addEventListener('change', function (){
  console.log(dateFrom.value);
  reservationFrom.innerHTML = dateFrom.value;
  reservationTo.innerHTML = dateTo.value;
});
        ...
        <div class="product__footer">
          ...
          <div class="bottom">
            <div class="btn__group">
              <button class="btn addToCart" data-id= ${id} >Dodaj do koszyka</button>
            </div>
